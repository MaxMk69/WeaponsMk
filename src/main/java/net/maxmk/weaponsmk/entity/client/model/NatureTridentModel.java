...
public class NatureTridentModel extends EntityModel<NatureTridentEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(WeaponsMk.MOD_ID, "nature_trident"), "main");
    private final ModelPart natureTrident;

    public NatureTridentModel(ModelPart root) {
        this.natureTrident = root.getChild("nature_trident");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition natureTrident = partdefinition.addOrReplaceChild("nature_trident", CubeListBuilder.create(), PartPose.ZERO);
    ...
    @Override
    public void setupAnim(NatureTridentEntity entity, float limbSwing, float limbSwingAmount,
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        natureTrident.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
}
