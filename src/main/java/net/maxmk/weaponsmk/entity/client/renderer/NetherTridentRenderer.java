...
import net.maxmk.weaponsmk.entity.client.model.NetheriteTridentModel;
...
@OnlyIn(Dist.CLIENT)
public class NetherTridentRenderer extends EntityRenderer<NetherTridentEntity> {
    private NetherTridentModel model;

    public NetherTridentRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new NetherTridentModel(pContext.bakeLayer(NetherTridentModel.LAYER_LOCATION));
    }

    @Override
    public void render(NetherTridentEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(NetherTridentEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(WeaponsMk.MOD_ID, "textures/item/nether_trident_3d.png");
    }
}
