...
import net.maxmk.weaponsmk.entity.client.model.ShadowTridentModel;
...
@OnlyIn(Dist.CLIENT)
public class ShadowTridentRenderer extends EntityRenderer<ShadowTridentEntity> {
    private ShadowTridentModel model;

    public ShadowTridentRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new ShadowTridentModel(pContext.bakeLayer(ShadowTridentModel.LAYER_LOCATION));
    }

    @Override
    public void render(ShadowTridentEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(ShadowTridentEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(WeaponsMk.MOD_ID, "textures/item/shadow_trident_3d.png");
    }
}
